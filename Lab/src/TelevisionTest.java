...
// HERE IS WHERE YOU DO TASK #5 
	...
	portable.power();
	System.out.println("A " + portable.getScreenSize() + " inch" + portable.getManufacturer() + " has been turned " + portable.getPowerStatus());
	System.out.println("What channel to change to?");
	station = keyboard.nextInt();
